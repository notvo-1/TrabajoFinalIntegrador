...
public class AppMenu {
     ...
     *
     * Patrón de inyección de dependencias (DI) manual: - CodigoBarrasDAO (sin
     * dependencias) - ProductoDAO (depende de CodigoBarrasDAO) -
     * CodigoBarraServiceImpl (depende de CodigoBarrasDAO) - ProductoServiceImpl
     * (depende de ProductoDAO y CodigoBarraServiceImpl) - MenuHandler (depende
     * de Scanner y ProductoServiceImpl)
     *
     ...
     *
     * Mapeo de opciones (corresponde a MenuDisplay): 1 → Crear producto (con
    ...
    private void processOption(int opcion) {
        switch (opcion) {
            case 1 ->
                menuHandler.crearProducto();
            case 2 ->
                menuHandler.listarProductos();
            case 3 ->
                menuHandler.buscarPorId();
            case 4 ->
                menuHandler.actualizarProducto();
            case 5 ->
                menuHandler.eliminarProducto();
            case 6 ->
                clearConsole();
            case 7 ->
                menuHandler.buscarPorNombre();
